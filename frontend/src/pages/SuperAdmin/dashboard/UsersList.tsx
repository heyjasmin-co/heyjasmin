  ...
  return (
    <div className="flex h-full flex-1 flex-col gap-4 overflow-y-auto rounded-2xl bg-white px-6 py-6 shadow-lg">
      <TitleCard
        ...
        subtitle="Administrative overview of registered users"
        hasButton={false}
      />
      <div
          ...
          <div className="flex flex-col gap-4 px-4 py-4">
            ...
            <div className="flex gap-2">
              ...
              <p className="text-sm text-gray-700">
                {appName} displays registered users for monitoring purposes.
                Super Admins can view and delete users from this list.
              </p>
            </div>
          </div>
