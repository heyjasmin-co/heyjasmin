export const newUserNotificationTemplate = (userName: string, userEmail: string) => {
	return `
  <!DOCTYPE html>
  <html lang="en">
    <head>
    ...
    <body style="margin:0; padding:0; font-family:Arial, sans-serif; background-color:#f3f4f6;">
      <div style="max-width:600px; margin:40px auto; background:white; border-radius:20px; border:1px solid #e5e7eb; box-shadow:0 4px 16px rgba(0,0,0,0.1); overflow:hidden;">
        ...
        <div style="padding:32px;">
          ...
          <p style="margin:0 0 16px 0; font-size:15px; color:#374151; line-height:1.6;">
            A new user has just created an account on <strong>heyjasmin</strong>!
          </p>

          <!-- User Info -->
          <div style="background:#f3e8ff; padding:16px; border-radius:12px; border:1px solid #ddd6fe; margin-top:16px;">
            <p style="margin:0; font-size:15px; color:#4f46e5;"><strong>Name:</strong> ${userName}</p>
            <p style="margin:4px 0 0 0; font-size:15px; color:#4f46e5;"><strong>Email:</strong> ${userEmail}</p>
          </div>

          <p style="margin:24px 0 0 0; font-size:15px; color:#374151;">
            You can now review the account and manage user access if needed.
          </p>

          <p style="margin:16px 0 0 0; font-size:13px; color:#6b7280;">
            This is an automated notification from heyjasmin.
          </p>
        </div>
