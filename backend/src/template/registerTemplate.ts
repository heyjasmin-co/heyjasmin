    ...
    <div style="max-width: 640px; margin: 40px auto; padding: 0 16px">
      ...
      >
        ...
        <p
          ...
          "
        >
          Thanks for choosing <strong>heyjasmin</strong> as your AI
          receptionist. We’re excited to help you capture every call, book more
          appointments, and keep your business running smoothly 24/7.
        </p>

        <!-- Tagline -->
        <div style="text-align: center; margin: 30px 0">
          <div
            style="height: 1px; background: #e9d5ff; margin-bottom: 16px"
          ></div>
          <p
            style="margin: 0; font-size: 18px; font-weight: 600; color: #6d28d9"
          >
        ...
        >
          ...
          <p
            style="margin: 0; font-size: 14px; color: #4b5563; line-height: 1.6"
          >
            Enjoy full access to heyjasmin’s premium features for the next 7
            days — no commitment, no risk.
          </p>
        </div>
